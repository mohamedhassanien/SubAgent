...
@Component({
  ...
  templateUrl: './archived-applications.component.html',
  styleUrls: ['./archived-applications.component.scss'],
})
export class ArchivedApplicationsComponent implements OnInit {
  ...
  getApplications() {
    this.loading = true;
    this._EmployeeService.getArchivedApplications().subscribe((data: any) => {
