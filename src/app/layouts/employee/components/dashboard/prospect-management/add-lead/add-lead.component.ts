...
export class AddLeadComponent implements OnInit {
  ...
  intakeYears: string[] = [ '2023','2024','2025'];
  ...
  sourceName: string = 'Select Source';
  ...
  sumbit(formData: FormGroup) {
    ...
    const sourceName = this.sourceName; //source === 'Other' ? customSource : source;
