...
@Component({
  selector: 'app-totalleads',
  templateUrl: './totalleads.component.html',
  styleUrls: ['./totalleads.component.scss'],
})
export class TotalleadsComponent implements OnInit {
  ...
  getStudents() {
    ...
    //       student.studentSource = student.studentSource;
    //       // const c = JSON.parse('["WOM"]');
    //       console.log(student.studentSource);
