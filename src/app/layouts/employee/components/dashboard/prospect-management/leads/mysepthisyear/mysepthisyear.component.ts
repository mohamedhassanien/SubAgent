...
@Component({
  selector: 'app-mysepthisyear',
  templateUrl: './mysepthisyear.component.html',
  styleUrls: ['./mysepthisyear.component.scss'],
})
export class MysepthisyearComponent implements OnInit {
