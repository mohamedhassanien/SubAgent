...
@Component({
  selector: 'app-myjanthisyear',
  templateUrl: './myjanthisyear.component.html',
  styleUrls: ['./myjanthisyear.component.scss'],
})
export class MyjanthisyearComponent implements OnInit {
