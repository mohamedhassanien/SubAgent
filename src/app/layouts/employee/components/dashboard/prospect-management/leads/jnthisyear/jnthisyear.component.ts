...
@Component({
  selector: 'app-jnthisyear',
  templateUrl: './jnthisyear.component.html',
  styleUrls: ['./jnthisyear.component.scss'],
})
export class JnthisyearComponent implements OnInit {
  ...
  // To get all students
  getStudents() {
    this._EmployeeService.getEmployeeStudentsjnnext().subscribe((data: any) => {
