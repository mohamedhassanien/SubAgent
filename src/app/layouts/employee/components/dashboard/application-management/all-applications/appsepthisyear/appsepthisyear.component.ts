...
@Component({
  selector: 'app-appsepthisyear',
  templateUrl: './appsepthisyear.component.html',
  styleUrls: ['./appsepthisyear.component.scss'],
})
export class AppsepthisyearComponent implements OnInit {
