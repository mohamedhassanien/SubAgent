...
@Component({
  selector: 'app-myappsep',
  templateUrl: './myappsep.component.html',
  styleUrls: ['./myappsep.component.scss'],
})
export class MyappsepComponent implements OnInit {
  ...
  // To get all students
  getApplications() {
    this._EmployeeService.getEmployeeAppssep().subscribe((data: any) => {
