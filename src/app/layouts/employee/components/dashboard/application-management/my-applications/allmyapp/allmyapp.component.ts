...
@Component({
  selector: 'app-allmyapp',
  templateUrl: './allmyapp.component.html',
  styleUrls: ['./allmyapp.component.scss'],
})
export class AllmyappComponent implements OnInit {
  ...
  // To get all students
  getApplications() {
    this._EmployeeService.getEmployeeAppstotal().subscribe((data: any) => {
