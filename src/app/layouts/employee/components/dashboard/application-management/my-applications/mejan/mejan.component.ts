...
@Component({
  selector: 'app-mejan',
  templateUrl: './mejan.component.html',
  styleUrls: ['./mejan.component.scss'],
})
export class MejanComponent implements OnInit {
  ...
  // To get all students
  getApplications() {
    this._EmployeeService.getEmployeeAppsj().subscribe((data: any) => {
